...
13. **Please note**: As `make` install location is set by `--prefix=/usr` pointing to actual `/usr/bin`, this wil replace main/system-wide `python` link
...
16. Have a python 3.6 environment, eg. namedly `TensorFlow1.5` in home directory or etc
